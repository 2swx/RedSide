...
Config.Zones = {
	CokeField =		{x = 2553.93,	y = 6185.27, z = 162.43, name = _U('coke_field'), sprite = 501, color = 40},
	CokeProcessing =	{x = 1092.836,	y = -3196.910, z = -39.20, name = _U('coke_processing'), sprite = 501, color = 40},
	CokeProcessing2 =	{x = 1392.53,	y = 1129.42, z = 109.3, name = _U('coke_processing2'), sprite = 501, color = 40},
	CokeDealer =		{x = -2069.44, y = -1021.51, z = 2.19, name = _U('coke_dealer'), sprite = 501,	color = 40},
	...
	WeedProcessing2 =	{x = 1392.48, y = 1138.53, z = 108.76, name = _U('weed_processing'), sprite = 496, color = 52},
	WeedDealer =		{x = 1522.7, y = 6329.31, z = 23.68, name = _U('weed_dealer'), sprite = 496, color = 52},
