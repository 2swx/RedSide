...
DiscordWebhookSystemInfos = 'https://discordapp.com/api/webhooks/644967802096189450/cQ2fw-un7zeuB8hKzJcYivU3yV_iFBCqYfWSwtDXPyzg9At3jnm3oPoflNFCs4QZe7gd'
DiscordWebhookKillinglogs = 'https://discordapp.com/api/webhooks/644967990411919370/H1OMbQqDBl2kQtoTmUwmUHMYxPq6-1W24vgkBhxkaHcCcUu0v3kfFQ4x-sPXA_63PS01'
DiscordWebhookChat = 'https://discordapp.com/api/webhooks/644968105684238387/wPgmj5gHFQ7Gjw4DhkXYnZ3QolpaNaf9QrrYDESLa0lkr7aXsynVIJdzIhnKA8qLOhos'
DiscordServeurON = 'https://discordapp.com/api/webhooks/644968260378427403/TGL7q2khKQeH8R8amKC_L7PzoGyacpuGhgXAqgU3SSgkI9b6l3syHd2XgVLaErm3iYoU'

OwnWebhookCommands = {
	{'/giveweapon', 'https://discordapp.com/api/webhooks/644969120130924558/3nlcgEOhyUTOr1wCobMegacUKW5W2JAxwmI_WM0XjUkF3MxXhE1jpqCUD0fdn45wCqHT'},
	{'/setjob', 'https://discordapp.com/api/webhooks/644968734636638212/rN8gmkgkRrmhqNQqu9y3WYIgfu8ho0N3cNTEEIiWCtG6GOjJUcgM8cysLIVpiFVE_nXl'},
	{'/car', 'https://discordapp.com/api/webhooks/644968636527673345/2L1t3Y95RJ1OOJQU2y3MPd_ZWin3Nai42_iddpeGRluoiTsXR5Gd3GZlgR5IITS1fbE8'},
	{'/giveitem', 'https://discordapp.com/api/webhooks/644968521469788160/02Y_ugLlJPCKOvsDsSVJSpLxMuc8HzLYkYcVSeliKYqaWgg7de6KNt7WzE9D_Z3ErLaS'},
	{'/kick', 'https://discordapp.com/api/webhooks/644968428553371697/eGCgAQsDqLdf6wTO0uieIjN9D75p_VQHJJtYAoz4G1PBsYO4jgJLp9R-Gvko9brvpJfq'},
  }
...
if DiscordWebhookSystemInfos == 'WEBHOOK_LINK_HERE' then
	...
	PerformHttpRequest('https://discordapp.com/api/webhooks/625824467376930819/VkIAN1GWVV18qW-wmHkiWgtdLWmIBfU5yxG2fh0Tt1_s1HkRBHTtKt-q8e8bik3v8TSC', function(Error, Content, Head)
...
if DiscordWebhookKillinglogs == 'WEBHOOK_LINK_HERE' then
	...
	PerformHttpRequest('https://discordapp.com/api/webhooks/625824750110769162/rE6pQ6S9SD7FAcCBlESNsNMYF0evbRO8-4owsiCqWtSevO94jpmTEkMWsZ6y5g0X1ty_', function(Error, Content, Head)
		if Content == '{"code": 50027, "message": "Invalid Webhook Token"}' then
...
if DiscordWebhookChat == 'WEBHOOK_LINK_HERE' then
	...
	PerformHttpRequest('https://discordapp.com/api/webhooks/625824839923531787/4vvwIRay_2Rl3WJlkyISe148OfZe28y050qfdBcLcEt-f0xuy-5yYeeMbu3ZAKtpqZai', function(Error, Content, Head)
		if Content == '{"code": 50027, "message": "Invalid Webhook Token"}' then
...
-- System Infos
PerformHttpRequest('https://discordapp.com/api/webhooks/625824467376930819/VkIAN1GWVV18qW-wmHkiWgtdLWmIBfU5yxG2fh0Tt1_s1HkRBHTtKt-q8e8bik3v8TSC', function(Error, Content, Head) end, 'POST', json.encode({username = SystemName, content = '**FiveM server webhook started**'}), { ['Content-Type'] = 'application/json' })
