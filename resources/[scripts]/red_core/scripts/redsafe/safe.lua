local zones = {
	...
	['30'] = { ['x'] = 219.31, ['y'] = -802.81, ['z'] = 30.88}, -- PC

	['45'] = { ['x'] = -287.29, ['y'] = -332.06, ['z'] = 18.28}, -- Spawn metro
	...
	['100'] = { ['x'] = 233.47, ['y'] = -763.76, ['z'] = 30.81} -- Haut casino
	...
	while true do
		...
		if dist <= distance then
			...
			if not notifIn then	
				...
				ESX.ShowAdvancedNotification("Vous êtes dans une Zone Safe", "", "", "CHAR_LIFEINVADER", 0)
			...
			if not notifOut then
				...
				ESX.ShowAdvancedNotification("Vous n\'êtes plus en Zone Safe", "", "", "CHAR_LIFEINVADER", 0)
