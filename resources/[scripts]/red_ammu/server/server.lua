...
function LoadLicenses (source)
  TriggerEvent('esx_license:getLicenses', source, function (licenses)
    TriggerClientEvent('yzk_ammu:loadLicenses', source, licenses)
  end)
end
...
RegisterServerEvent('yzk_ammu:buyLicense')
AddEventHandler('yzk_ammu:buyLicense', function ()
  ...
  if xPlayer.get('money') >= Config.LicensePrice then
    ...
    TriggerClientEvent('yzk_ammu:PlaySoundSucces', _source)
  else
    --TriggerClientEvent('esx:showNotification', _source, _U('not_enough'))
    TriggerClientEvent('yzk_ammu:PlaySoundRater', _source)
  end
end)
...
RegisterNetEvent('buyYzk')
AddEventHandler('buyYzk', function()
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(source)
    local price = Config.PriceYzk
    xPlayer.removeMoney(price)
