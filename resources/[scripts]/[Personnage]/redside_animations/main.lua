...
mainMenu = NativeUI.CreateMenu("Animations", "Animations")
...
function AddSubMenuSaluteMenu(menu)
	...
	local military23Item = NativeUI.CreateItem("On est pas sur RedSide nous ?", "")
...
function AddSubMenuOtherMenu(menu)
	...
	local sit5Item = NativeUI.CreateItem("S'asseoir par terre", "")
	animOtherMenu.SubMenu:AddItem(sit5Item)
	local sit6Item = NativeUI.CreateItem("S'asseoir", "")
...
function AddSubMenuPEGI21Menu(menu)
	...
	local strip1Item = NativeUI.CreateItem('Strip Tease1', "")
	animPegiMenu.SubMenu:AddItem(strip1Item)
	local strip2Item = NativeUI.CreateItem('Strip Tease2', "")
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustPressed(1, 170) then -- F3 
