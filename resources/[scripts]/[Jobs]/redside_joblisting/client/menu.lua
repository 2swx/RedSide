...
function AddMenuJobMenu(menu)
		...
		if item == minerjob then
			...
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Mineur~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
		if item == fishermanjob then
		    TriggerServerEvent('esx_joblisting:setJobFishing')
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Pêcheur~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
		if item == fuelerjob then
		    TriggerServerEvent('esx_joblisting:setJobFueler')
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Raffineur~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
		if item == lumberjackjob then
		    TriggerServerEvent('esx_joblisting:setJobLumberJack')
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Bûcheron~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
		if item == slaughtererjob then
		    TriggerServerEvent('esx_joblisting:setJobAbatteur')
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Abatteur~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
		if item == tailorjob then
		    TriggerServerEvent('esx_joblisting:setJobTailor')
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Couturier~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
		if item == salvagejob then
		    TriggerServerEvent('esx_joblisting:setJobSalvage')
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Plongeur~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
		if item == fruitierjob then
		    TriggerServerEvent('esx_joblisting:setJobFruitier')
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Fruitier~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
                if item == orpjob then
		    TriggerServerEvent('esx_joblisting:setJobOrp')
			ESX.ShowAdvancedNotification("Pôle Emploi", "~b~Fini le Chômage ~w~!", "Vous pratiquez désormais le métier de \"~b~Orpailleur~w~\" ~w~!", "CHAR_BEVERLY", 1)
		end
	end
end
