			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'billing', {
				...
				if amount == nil then
					...
					if closestPlayer == -1 or closestDistance > 5.0 then
						...
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_ammu', 'Armurier', amount)
					end
				end
		...
		-- if data.current.value == 'billing' then
			...
			-- }, function(data, menu)
				...
				-- else
					...
					-- else
						-- menu.close()
						-- TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_ammu', _U('mechanic'), amount)
					-- end
				-- end
			-- end, function(data, menu)
				-- menu.close()
