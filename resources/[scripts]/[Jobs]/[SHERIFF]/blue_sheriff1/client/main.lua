...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('blue_concessionaire:retrieveJobVehicles', function(jobVehicles)
						...
						if data2.current.stored then
							...
							if foundSpawn then
								...
								ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
									...
									TriggerServerEvent('blue_concessionaire:setJobVehicleState', data2.current.vehicleProps.plate, false)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				local newPlate = exports['blue_concessionaire']:GeneratePlate()
...
AddEventHandler('sheriff:setBlip', function(coords, raison, sourceX)
	if enDemande == false then
		...
		enDemande = true
		function NewBlipSend()
			ESX.TriggerServerCallback('sheriff:renfortRefresh', function(coords2)
				blipId = AddBlipForCoord(coords2.x, coords2.y, coords2.z)
		...
		ESX.ShowNotification('~r~Une demande de renfort a été refusée car une autre est déjà en place.')
	end
end)
