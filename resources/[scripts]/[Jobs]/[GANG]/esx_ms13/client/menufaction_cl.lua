      ...
      if data.current.value == 'citizen_interaction' then
        ...
        ESX.UI.Menu.Open(
         ...
         --     if data2.current.value == 'handcuff' then
           --     TriggerServerEvent('esx_ms13:handcuffPasta', GetPlayerServerId(player))
            --  end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_ms13:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_ms13:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_ms13:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenBodySearchMenu(player)
  ...
  ESX.TriggerServerCallback('esx_ms13:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_ms13:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_ms13:getVehicleInfos', function(infos)
...
RegisterNetEvent('esx_ms13:handcuffPasta')
AddEventHandler('esx_ms13:handcuffPasta', function()
...
RegisterNetEvent('esx_ms13:drag')
AddEventHandler('esx_ms13:drag', function(cop)
...
RegisterNetEvent('esx_ms13:putInVehicle')
AddEventHandler('esx_ms13:putInVehicle', function()
...
RegisterNetEvent('esx_ms13:OutVehicle')
AddEventHandler('esx_ms13:OutVehicle', function(t)
...
--Citizen.CreateThread(function()
  --  while true do
	...
	--	if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ms13' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
		--   OpenBanditsMenu()
      --  end 
--    end
--end)
