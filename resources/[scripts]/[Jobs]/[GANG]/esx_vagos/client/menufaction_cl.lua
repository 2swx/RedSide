      ...
      if data.current.value == 'citizen_interaction' then
        ...
        ESX.UI.Menu.Open(
         ...
         --     if data2.current.value == 'handcuff' then
           --     TriggerServerEvent('esx_vagos:handcuffPasta', GetPlayerServerId(player))
           --   end
...
--		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'vagos' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
--		  OpenBanditsMenu()
 --       end 
--    end
--end)
