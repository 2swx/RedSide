        ...
        --      {label = 'Ligotter/Enlever',               value = 'handcuff'},
          ...
          function(data2, menu2)
           ...
           --   if data2.current.value == 'handcuff' then
             --   TriggerServerEvent('esx_ballas:handcuffPasta', GetPlayerServerId(player))
            --  end
...
--RegisterNetEvent('esx_ballas:handcuffPasta')
--AddEventHandler('esx_ballas:handcuffPasta', function()
...
--		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'ballas' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
	--	   OpenBanditsMenu()
    --    end 
 --   end
--end)
