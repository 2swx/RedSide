...
--RegisterServerEvent('esx_ballas:handcuffPasta')
--AddEventHandler('esx_ballas:handcuffPasta', function(target)
  --TriggerClientEvent('esx_ballas:handcuffPasta', target)
--end)
