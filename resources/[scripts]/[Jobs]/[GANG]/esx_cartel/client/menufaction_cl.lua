         ...
         --     {label = 'Ligotter/Enlever',               value = 'handcuff'},
          ...
          function(data2, menu2)
            ...
            --  if data2.current.value == 'handcuff' then
              --  TriggerServerEvent('esx_cartel:handcuffPasta', GetPlayerServerId(player))
             -- end
...
--Citizen.CreateThread(function()
 --   while true do
      --  Citizen.Wait(1)
		...
		--if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'cartel' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
		 -- OpenBanditsMenu()
      --  end 
 --   end
--end)
