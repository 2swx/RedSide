...
RegisterServerEvent('esx_cartel:buyItem1')
AddEventHandler('esx_cartel:buyItem1', function()
  	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_cartel', function(account)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_cartel', function(inventory)
...
RegisterServerEvent('esx_cartel:buyItem2')
AddEventHandler('esx_cartel:buyItem2', function()
  	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_cartel', function(account)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_cartel', function(inventory)
...
RegisterServerEvent('esx_cartel:handcuffPasta')
AddEventHandler('esx_cartel:handcuffPasta', function(target)
  TriggerClientEvent('esx_cartel:handcuffPasta', target)
end)
...
TriggerEvent('esx_society:registerSociety', 'cartel', 'cartel', 'society_cartel', 'society_cartel', 'society_cartel', {type = 'private'})
...
RegisterServerEvent('esx_cartel:getStockItemsBandits')
AddEventHandler('esx_cartel:getStockItemsBandits', function(itemName, count)
...
ESX.RegisterServerCallback('esx_cartel:getStockItemsBandits',function(source, cb)
...
-- RegisterServerEvent('esx_cartel:putStockItemsBandits')
-- AddEventHandler('esx_cartel:putStockItemsBandits', function(itemName, count)
...
ESX.RegisterServerCallback('esx_cartel:putStockItemsBandits',function(source, cb)
...
RegisterServerEvent('esx_cartel:startHarvestBandits')
AddEventHandler('esx_cartel:startHarvestBandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:stopHarvestBandits')
AddEventHandler('esx_cartel:stopHarvestBandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:startHarvest2Bandits')
AddEventHandler('esx_cartel:startHarvest2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:stopHarvest2Bandits')
AddEventHandler('esx_cartel:stopHarvest2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:startHarvest3Bandits')
AddEventHandler('esx_cartel:startHarvest3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:stopHarvest3Bandits')
AddEventHandler('esx_cartel:stopHarvest3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:startHarvest4Bandits')
AddEventHandler('esx_cartel:startHarvest4Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:stopHarvest4Bandits')
AddEventHandler('esx_cartel:stopHarvest4Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:startCraftBandits')
AddEventHandler('esx_cartel:startCraftBandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:stopCraftBandits')
AddEventHandler('esx_cartel:stopCraftBandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:startCraft2Bandits')
AddEventHandler('esx_cartel:startCraft2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:stopCraft2Bandits')
AddEventHandler('esx_cartel:stopCraft2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:startCraft3Bandits')
AddEventHandler('esx_cartel:startCraft3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_cartel:stopCraft3Bandits')
AddEventHandler('esx_cartel:stopCraft3Bandits', function()
  local _source = source
...
-- ESX.RegisterServerCallback('esx_cartel:getArmoryWeaponsBandits',function(source, cb)
...
ESX.RegisterServerCallback('esx_cartel:addArmoryWeaponBandits',function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_cartel:removeArmoryWeaponBandits',function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_cartel:buyBandits',function(source, cb, amount)
...
-----------------------------------------------------------------------------------------------------------------------
ESX.RegisterServerCallback('esx_cartel:getBlackMoneySociety', function(source, cb)
  local _source = source
  local xPlayer    = ESX.GetPlayerFromId(_source)
  local blackMoney = 0
  local items      = {}
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_cartel_weapons', function(store)
...
RegisterServerEvent('esx_cartel:getItem')
AddEventHandler('esx_cartel:getItem', function(type, item, count)
...
RegisterServerEvent('esx_cartel:putItem')
AddEventHandler('esx_cartel:putItem', function(type, item, count)
...
ESX.RegisterServerCallback('esx_cartel:getPlayerInventory2', function(source, cb)
  local _source = source
  local xPlayer    = ESX.GetPlayerFromId(_source)
