...
GodModKickMessage = "CHEAT DETECTED ! VOUS AVEZ ETE EXCLUS DU SERVEUR - [Cheat detection #".. platenum .."]."
kickMessage = "CHEAT DETECTED ! YOU ARE NOT ALLOWED TO PLAY HERE! [Mod Menu detection #".. platenum .."]."
kickMessagePolice = "DETECTION VOLE DE VEHICULE! Voler des véhicule de service police/ems n'est pas autorisé! Merci de lire le réglement. [Detection #".. platenum .."]."
BanMessageLuaInjection = "LUA MOD MENU / INJECTION DETECTED - YOU ARE GLOBALLY BANNED FROM THIS SERVER [Ban ID: #".. platenum .."]."
BanMessageHealthHack = "CHEAT DETECTED - YOU ARE GLOBALLY BANNED FROM THIS SERVER [Ban ID: #".. platenum .."]."
KickSessionSolo = "SESSION SOLO DETECTED - Vous avez été kick du serveur, merci de vous reconnecter.\n[Detection #".. platenum .."]."
